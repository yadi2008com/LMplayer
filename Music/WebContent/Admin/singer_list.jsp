...
<%-- $.ajax({
	...
	//取出传回来的参数error并与yes比较
	 ...
	 // console.log(registerOki.length());
				...
				<div class="ui_tb">
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0" id="singer">
						...
						<tr>
							...
							<td>
							<a href='<%=path %>/SingerDelServlet?singerId=<%=singersBeanInfo.getSingerId()%>'>删除</a>
							<a href='<%=path %>/SingerSelServlet?singerId=<%=singersBeanInfo.getSingerId()%>'>修改</a>
							</td>
						</tr>
						<%
						}
