	...
	success:function(data){
		if(null!=data && ""!=data){
			...
			$.each(songs,function(num,item){
				$("#songList").append("<tr><td><a href='/Music/SongDelServlet?songId="+item.songId+"'>删除</a></td></tr>");
			});
		}
	}
		...
		<div id="container">
			...
			<div class="ui_content">
				...
				<div class="ui_tb_h30">
					...
					<div class="ui_frt">
						<!--    如果是第一页，则只显示下一页、尾页 -->
						<a href="SongListServlet?pageno=<%=(pageBean.getPageno()-1)%>">上一页</a>
						<a href="SongListServlet?pageno=<%=(pageBean.getPageno()+1)%>">下一页</a>
