				...
				<div class="Lsong">
					<!-- ----------------------------------------加java代码 -->
					 <div class="LsongSingle">
					 	  ...
					 	  <a href="songPlay.jsp?songId=1">泡沫-邓紫棋</a>
					 </div>	
					 <div class="LsongSingle">
					 	  <img alt="REFRESH" title="REFRESH" src="../Img/2.jpg"/>
					 	  <a href="songPlay.jsp?songId=2">喜欢你-邓紫棋</a>
					 </div>
					 <div class="LsongSingle">
					 	  <img alt="REFRESH" title="REFRESH" src="../Img/3.jpg"/>
					 	  <a href="songPlay.jsp?songId=2">歌单名称</a>
					 </div>	
					 <div class="LsongSingle">
					 	  <img alt="REFRESH" title="REFRESH" src="../Img/4.jpg"/>
					 	  <a href="songPlay.jsp?songId=2">歌单名称</a>
					 </div>	
					 <div class="LsongSingle">
					 	  <img alt="REFRESH" title="REFRESH" src="../Img/5.jpg"/>
					 	  <a href="songPlay.jsp?songId=2">歌单名称</a>
					 </div>
					 <div class="LsongSingle">
					 	  <img alt="REFRESH" title="REFRESH" src="../Img/6.jpg"/>
					 	  <a href="songPlay.jsp?songId=2">歌单名称</a>
					 </div>	
					 <div class="LsongSingle">
					 	  <img alt="REFRESH" title="REFRESH" src="../Img/3.jpg"/>
