...
/**
 * Servlet implementation class SingerListServlet
 */
@WebServlet("/SingerListServlet")
public class SingerListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<SingersBean> singersBeanInfoList =singerBiz.fetchAllSingersInfoList(pageno);
