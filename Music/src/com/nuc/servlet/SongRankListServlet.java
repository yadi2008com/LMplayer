...
/**
 * Servlet implementation class SongRankListServlet
 */
@WebServlet("/SongRankListServlet")
public class SongRankListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SongRankListServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("Admin/music_rank.jsp").forward(request, response);
