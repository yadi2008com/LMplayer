...
import static com.cyd.lmplayer.Constants.THEME_DESCRIPTION;
import static com.cyd.lmplayer.Constants.THEME_PREVIEW;
import static com.cyd.lmplayer.Constants.THEME_TITLE;
    ...
    protected void onBindView(View view) {
        ...
        if (themePackageName != null && themePackageName.toString().length() > 0) {
            ...
            if (themePreview != null)
                ...
                vThemePreview.setImageResource(R.drawable.app_icon);
            vThemeTitle.setText(themeName);
