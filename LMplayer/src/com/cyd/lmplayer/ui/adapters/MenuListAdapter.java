...
import com.cyd.lmplayer.activities.SearchActivity;
import com.cyd.lmplayer.helpers.utils.MusicUtils;
import com.cyd.lmplayer.helpers.utils.ScanSdReceiver;
...
//	}
	...
	private  void AboutDialog1(){
		LayoutInflater in = context.getLayoutInflater();
		final View about_view = in.inflate(R.layout.about_dialog1, null);
		new AlertDialog.Builder(context).setIcon(R.drawable.app_icon).setTitle(R.string.about)
		.setView(about_view).setPositiveButton(R.string.Yes,new DialogInterface.OnClickListener() {	
	...
	private  void AboutDialog2(){
		LayoutInflater in = context.getLayoutInflater();
		final View about_view = in.inflate(R.layout.about_dialog2, null);
		new AlertDialog.Builder(context).setIcon(R.drawable.app_icon).setTitle(R.string.about)
		.setView(about_view).setPositiveButton(R.string.Yes,new DialogInterface.OnClickListener() {	
	...
	private  void AboutDialog3(){
		LayoutInflater in = context.getLayoutInflater();
		final View about_view = in.inflate(R.layout.about_dialog3, null);
		new AlertDialog.Builder(context).setIcon(R.drawable.app_icon).setTitle(R.string.about)
		.setView(about_view).setPositiveButton(R.string.Yes,new DialogInterface.OnClickListener() {	
...
//            context.startActivityForResult(i, 0);
	...
	private void init(){
		...
		for(int i = 0; i < this.itemCount; i++){
			...
			if(i == 0){
				map.put("menuText", "      酷乐随行，愉悦心情! ");
			} 
			else if(i == 1){
				map.put("menuText", "  中北简介");
			}
			else if(i == 2){
				//map.put("menuText","  系统设置");
				map.put("menuText","  版本信息");
			}
			else if(i == 3){
				map.put("menuText", "  本地搜索");
			}
			else if(i == 4){
				map.put("menuText","  随便来一曲");
			}
			else if(i == 5){
				map.put("menuText", "  刷新乐库");
			}
			else if(i == 6){
				map.put("menuText", "  关于LM音乐播放器");
			}
			else if(i == 7){
				map.put("menuText", "  退    出");
			}
