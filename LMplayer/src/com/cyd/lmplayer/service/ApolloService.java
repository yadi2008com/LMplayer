...
import com.cyd.lmplayer.app.widgets.AppWidget11;
import com.cyd.lmplayer.app.widgets.AppWidget41;
import com.cyd.lmplayer.app.widgets.AppWidget42;
import com.cyd.lmplayer.cache.ImageInfo;
import com.cyd.lmplayer.helpers.GetBitmapTask;
import com.cyd.lmplayer.helpers.utils.ImageUtils;
import com.cyd.lmplayer.helpers.utils.MusicUtils;
import com.cyd.lmplayer.helpers.utils.VaulePreference;
import com.cyd.lmplayer.helpers.utils.VisualizerUtils;
import com.cyd.lmplayer.preferences.SharedPreferencesCompat;
import com.cyd.lmplayer.IApolloService;
import com.cyd.lmplayer.R;

import static com.cyd.lmplayer.Constants.APOLLO_PREFERENCES;
import static com.cyd.lmplayer.Constants.DATA_SCHEME;
...
public class ApolloService extends Service implements GetBitmapTask.OnBitmapReadyListener {
     ...
     * played
     * 指向包名的activity
     * 字符串相当于activity，启动服务，activity对应的路径
     */
    ...
    public static final String APOLLO_PACKAGE_NAME = "com.cyd.lmplayer";

    public static final String MUSIC_PACKAGE_NAME = "com.android.music";

    public static final String PLAYSTATE_CHANGED = "com.cyd.lmplayer.playstatechanged";

    public static final String META_CHANGED = "com.cyd.lmplayer.metachanged";

    public static final String FAVORITE_CHANGED = "com.cyd.lmplayer.favoritechanged";

    public static final String QUEUE_CHANGED = "com.cyd.lmplayer.queuechanged";

    public static final String REPEATMODE_CHANGED = "com.cyd.lmplayer.repeatmodechanged";

    public static final String SHUFFLEMODE_CHANGED = "com.cyd.lmplayer.shufflemodechanged";

    public static final String PROGRESSBAR_CHANGED = "com.cyd.lmplayer.progressbarchnaged";

    public static final String REFRESH_PROGRESSBAR = "com.cyd.lmplayer.refreshprogessbar";

    public static final String CYCLEREPEAT_ACTION = "com.cyd.lmplayer.musicservicecommand.cyclerepeat";

    public static final String TOGGLESHUFFLE_ACTION = "com.cyd.lmplayer.musicservicecommand.toggleshuffle";

    public static final String SERVICECMD = "com.cyd.lmplayer.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "com.cyd.lmplayer.musicservicecommand.togglepause";

    public static final String PAUSE_ACTION = "com.cyd.lmplayer.musicservicecommand.pause";

    public static final String PREVIOUS_ACTION = "com.cyd.lmplayer.musicservicecommand.previous";

    public static final String NEXT_ACTION = "com.cyd.lmplayer.musicservicecommand.next";
    ...
    public static MultiPlayer mPlayer;
    ...
    public static  int IDLE_DELAY = 90000;//FIW ME can change the time to stop
...
//                    stopSelf(mServiceStartId);
    ...
    public void onCreate() {
        ...
        //新建一个VaulePreference，用于Guide界面中是否已开启过的判断
    ...
    public boolean open(String path) {
        synchronized (this) {
            ...
            mFileToPlay = path;
            System.out.println("The Opening Path"+mFileToPlay);
...
//                            : R.drawable.apollo_holo_dark_pause);
    ...
    public static  MediaPlayer lrc_CurrentMediaPlayer;
    /**
